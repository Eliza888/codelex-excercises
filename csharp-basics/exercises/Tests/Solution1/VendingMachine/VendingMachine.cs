...
namespace VendingMachine
{
    public class VendingMachine : IVendingMachine
    {
        ...
        private Money _amount = new Money { Euros = 0, Cents = 0 };
        ...
        public Money InsertCoin(Money amount)
        {
            if (IsValidCoin(amount))
            {
                ...
                Debug.WriteLine($"Euros after adding {amount.Euros}: {_amount.Euros}");
                Debug.WriteLine($"Cents after adding {amount.Cents}: {_amount.Cents}");
        ...
        public Money ReturnMoney()
        {
            ...
            Debug.WriteLine($"Before reset: Euros = {_amount.Euros}, Cents = {_amount.Cents}");

            _amount.Euros = 0;
            _amount.Cents = 0;

            Debug.WriteLine($"After reset: Euros = {_amount.Euros}, Cents = {_amount.Cents}");
        ...
        public Money CalculateChange(Money insertedAmount, Money productPrice)
        {
            int totalInsertedCents = insertedAmount.Euros * 100 + insertedAmount.Cents;
            int totalProductCents = productPrice.Euros * 100 + productPrice.Cents;
